import { IoStatsChart, IoSchool, IoWallet, IoShieldCheckmark, IoInformationCircle, IoPeople, IoDocumentText, IoLogoWhatsapp } from "react-icons/io5";

const features = [
    {
        icon: <IoStatsChart className="w-8 h-8 text-blue-500" />,
        title: "Dashboard Insight",
        description: "Pantau metrik penting dan statistik sekolah secara real-time dalam satu tampilan."
    },
    {
        icon: <IoPeople className="w-8 h-8 text-green-500" />,
        title: "Manajemen Pengguna",
        description: "Kelola data siswa, wali murid, guru, dan staff sekolah dengan mudah dan terpusat."
    },
    {
        icon: <IoShieldCheckmark className="w-8 h-8 text-purple-500" />,
        title: "Keamanan Terjamin",
        description: "Kontrol hak akses dan keamanan data sensitif sekolah dengan standar enkripsi tinggi."
    },
    {
        icon: <IoDocumentText className="w-8 h-8 text-yellow-500" />,
        title: "Laporan Lengkap",
        description: "Akses dan unduh laporan akademik maupun administratif sekolah kapan saja."
    },
    {
        icon: <IoSchool className="w-8 h-8 text-red-500" />,
        title: "Integrasi Akademik",
        description: "Sinkronisasi data kurikulum, jadwal, dan nilai siswa secara otomatis."
    },
];
        ...
        <div className="container mx-auto px-4 py-12 max-w-6xl">
            <div className="text-center mb-16 space-y-4">
                ...
                <p className="text-lg md:text-xl text-gray-600 dark:text-gray-300 max-w-3xl mx-auto leading-relaxed">
                    Pusat Kontrol & Manajemen Sistem YISS. Platform terpadu untuk mengelola seluruh aspek operasional sekolah dengan efisien, aman, dan transparan.
                </p>
            </div>
            ...
            <div className="bg-gradient-to-br from-blue-600 to-indigo-700 rounded-3xl p-10 md:p-16 text-center text-white shadow-xl overflow-hidden relative isolate">
                <div className="relative z-10">
                    <h2 className="text-3xl md:text-4xl font-bold mb-6 tracking-tight">Butuh Bantuan Teknis?</h2>
                    <p className="mb-8 text-blue-100 text-lg max-w-2xl mx-auto">
                        Tim support kami siap membantu Anda. Hubungi kami melalui WhatsApp untuk respon cepat.
                    </p>
                    <a
